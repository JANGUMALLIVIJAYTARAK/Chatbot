...
def analyze_document_route():
    ...
    # --- MODIFICATION START: Extract user API keys from the request ---
    user_gemini_api_key = data.get('user_gemini_api_key')
    user_grok_api_key = data.get('user_grok_api_key')
    # --- MODIFICATION END ---
    ...
    try:
        ...
        # --- MODIFICATION START: Pass API keys to the llm_handler ---
...
def generate_chat_response_route():
    ...
    if perform_rag:
        ...
        if enable_multi_query:
            try:
                # --- MODIFICATION START: Pass API keys to sub-query generation ---
    ...
    try:
        ...
        # --- MODIFICATION START: Pass API keys to the main response generation ---
